...
class FoodRepositoryImpl
    ...
    constructor(
        ...
        override suspend fun getFoodById(id: Long): NetworkResult<Food> =
            try {
        ...
        override suspend fun getFoodByBarcodeLocal(barcode: String): NetworkResult<Food> =
            try {
        ...
        override suspend fun insertFood(food: Food): NetworkResult<Long> =
            try {
        ...
        override suspend fun insertFoods(foods: List<Food>): NetworkResult<List<Long>> =
            try {
        ...
        override suspend fun updateFood(food: Food): NetworkResult<Unit> =
            try {
        ...
        override suspend fun deleteFood(food: Food): NetworkResult<Unit> =
            try {
         ...
         */
        override fun searchFoodsByNameRemote(
            query: String,
            page: Int
        ): Flow<NetworkResult<com.ruslan.foodtracker.domain.model.PaginatedResult<Food>>> =
            remoteDataSource
                .searchProducts(query, page = page, pageSize = 20)
